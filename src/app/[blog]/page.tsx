...
Put succinctly, The Title Discovery Promotion provides marketing and merchandising opportunities for authors and publishers to have their books promoted to retailers, libraries, and community reader sites. You’ll be able to use digital ad campaigns, book lists, giveaway mailings, and more to raise awareness for your books and reach more readers. There are two packages available: Discovery Basic and Discovery Boost.

Discovery Basic costs $350 per ISBN. With this package, your book will be included in exclusive curated lists like IngramSpark’s seasonal books catalog shared with booksellers, book lists and themed articles on popular e-commerce and reader community sites, and targeted digital book flyers delivered to independent retailers.

Discovery Boost costs $500 per ISBN. You’ll get all the resources in Discovery Basic, plus you’ll gain valuable insights and optimize your book metadata with recommendations from book-selling experts, samples of your book are made available for retail and library buyers, giveaways, and reviews on reader community sites; the Ingram Content Group sales teams in the U.S. and UK will be made aware of your book, and we’ll provide promotion within the Ingram Content Group UK book ordering catalog.

Register your interest for the package that's right for you.
...
If your book is chosen for inclusion in the promotion you will receive an email notification. Once the book or books have been listed by our team, you will receive a proof of performance email containing links to your book’s postings so you can share via your social media and marketing efforts. Promotions occur throughout the year and each one will last at least three months. These promotional packages are currently only available for U.S.-based accounts.</p>
</section>
