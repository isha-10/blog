      ...
      <div className="p-4 md:w-1/3">
        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            Self-publishing your book is quite an accomplishment, but unless you printed something deeply personal that’s just for you or a gift for someone close, you want everyone to buy and read your book.
            </p>
